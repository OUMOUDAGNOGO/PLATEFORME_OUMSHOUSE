                  ...
                  <ul class="list-unstyled components">
                     <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="dashboard">
                           <li>
                              <a href="{{Route('Produit.index')}}"><span>Liste des produits </span></a>
                           </li>
                           <li>
                              <a href="{{Route('produit.produitRegistre')}}"> <span>Ajouter Produit</span></a>
                           </li>
                     ...
                     <li>
                      ...
                      <ul class="collapse list-unstyled" id="element">
                          <li><a href="{{route('categorie.index')}}"> <span>Liste des categorie</span></a></li>
                          <li><a href="{{route('categorie.create')}}"> <span>Ajouter categorie</span></a></li>
                      </ul>
                    </li>
                  </ul>
               </div>
