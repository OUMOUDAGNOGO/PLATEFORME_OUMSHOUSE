            ...
            <div class="header_top d_none1">
               <div class="container">
                  <div class="row">
                     <div class="col-md-4">
                        <ul class="conta_icon ">
                           <li><a href="#"><img src="{{asset('dcc/images/call.png')}}" alt="#"/>Call us: 0126 - 922 - 0162</a> </li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                  ...
                  <div class="row d_flex">
                     <div class="col-md-4">
                        <ul class="conta_icon d_none1">
                           <li><a href="#"><img src="{{asset('dcc/images/email.png')}}" alt="#"/> demo@gmail.com</a> </li>
                        </ul>
                     </div>
                     <div class="col-md-4">
                        <a class="logo" href="#"><img src="{{asset('dcc/images/logo.png')}}" alt="#"/></a>
                     </div>
                     <div class="col-md-4">
      ...
      <section class="banner_main">
         <div class="container">
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="ban_img">
                     <figure><img src="{{asset('dcc/images/ban_img.png')}}" alt="#"/></figure>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-md-2 col-sm-4 pa_left">
                  <div class="six_probpx yellow_bg">
                     <i><img src="{{asset('dcc/images/shoes.png')}}" alt="#"/></i>
                     <span>Shoes</span>
                  </div>
               </div>
               <div class="col-md-2 col-sm-4 pa_left">
         ...
         <div class="container">
            ...
            <div class="product_main">
                  ...
                  <div class="project_box ">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/shoes1.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
            
             
                  <div class="project_box ">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/shoes2.png')}}" alt="#"/></div>
                     <h3 >Short Openwork Cardigan $120.00</h3>
                  </div>
               
                  <div class="project_box">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/shoes3.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
              
                  <div class="project_box">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/shoes4.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
              
                  <div class="project_box">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/shoes5.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
              
            
                  <div class="project_box ">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/tisat1.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
              
                  <div class="project_box ">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/tisat2.png')}}" alt="#"/></div>
                     <h3 >Short Openwork Cardigan $120.00</h3>
                  </div>
               
                  <div class="project_box">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/tisat3.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
               
                  <div class="project_box">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/tisat4.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
               
                  <div class="project_box">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/tisat5.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
               
            
                  <div class="project_box ">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/mix1.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
               
                  <div class="project_box ">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/mix2.png')}}" alt="#"/></div>
                     <h3 >Short Openwork Cardigan $120.00</h3>
                  </div>
               
                  <div class="project_box">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/mix3.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
              
                  <div class="project_box">
                     <div class="dark_white_bg" ><img  src="{{asset('dcc/images/mix4.png')}}" alt="#"/></div>
                     <h3>Short Openwork Cardigan $120.00</h3>
                  </div>
