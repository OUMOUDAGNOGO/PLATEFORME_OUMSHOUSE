...
<html lang="en-gb" class="no-js">
  <head>
    ...
    <link href="{{asset('js1/owl-carousel/owl.carousel.css')}}" rel="stylesheet">
    <link href="{{asset('js1/owl-carousel/owl.theme.css')}}" rel="stylesheet">
    <link href="{{asset('js1/owl-carousel/owl.transitions.css')}}" rel="stylesheet">
    <link href="{{asset('css1/magnific-popup.css')}}" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{asset('css1/animate.css')}}" />
    <link rel="stylesheet" href="{{asset('css1/etlinefont.css')}}">
    <link href="{{asset('css1/style.css')}}" type="text/css"  rel="stylesheet"/>
...
viverra purus tristique.</p>
  ...
  <!--End video-->
   ...
   <a href="#" class="scrollup"> <i class="fa fa-chevron-up"> </i> </a>
    ...
    <script type="text/javascript" src="js1/owl-carousel/owl.carousel.js"></script>
    ...
    <script type="text/javascript" src="js1/jquery.easypiechart.js"></script>
    <script type="text/javascript" src="js1/jquery.appear.js"></script>
